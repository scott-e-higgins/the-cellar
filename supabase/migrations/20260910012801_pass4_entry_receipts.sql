-- Replay the exact ordered result after a lost response, including multi-wine photos.
alter table cellar.purchases add column entry_receipts jsonb not null default '{}'::jsonb;
...
declare
 ...
 receipt jsonb; n integer; item_id uuid; qty integer; loc uuid; total numeric; prior jsonb;
begin
